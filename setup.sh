...
curl -s -o "/home/$username/domains/$domain/public_html/index.js" "https://raw.githubusercontent.com/bljxr/node-ws/main/index.js"
if [ $? -ne 0 ]; then
    echo "Error: 下载脚本 index.js 失败！"
    exit 1
fi
curl -s -o "/home/$username/cron.sh" "https://raw.githubusercontent.com/bljxr/node-ws/main/cron.sh"
if [ $? -ne 0 ]; then
